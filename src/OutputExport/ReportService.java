...
public class ReportService {
    ...
    private String buildReportText(AnalysisResult r, RangeResult range, boolean includeRange) {
        ...
        sb.append("파일명(")
          .append(nullSafe(r.getSourceFileName()))
          .append(") log ( 생성된 날짜 ")
          .append(nullSafe(r.getLogCreatedDate()))
          .append(" )\n");

        sb.append("1. 최다 사용키 : ")
          .append(nullSafe(r.getTopKey()))
          .append(" ")
          .append(r.getTopKeyCount())
          .append("회\n");
        ...
        if (includeRange && range != null) {
            sb.append("7. ")
              .append(range.getStartLine())
              .append("~")
              .append(range.getEndLine())
              .append("번째 정보\n");
            sb.append("최다사용 키의 이름과 횟수 | ")
              .append(nullSafe(range.getTopKey()))
              .append(" ")
              .append(range.getTopKeyCount())
              .append("회\n");
        }//end if
