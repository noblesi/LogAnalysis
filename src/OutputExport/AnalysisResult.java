...
public class AnalysisResult {
	...
	public String toString() {
		return "AnalysisResult [sourceFileName=" + sourceFileName + ", logCreatedDate=" + logCreatedDate + ", topKey="
				+ topKey + ", topKeyCount=" + topKeyCount + ", browserCount=" + browserCount + ", browserRate="
				+ browserRate + ", success200Count=" + success200Count + ", fail404Count=" + fail404Count
				+ ", peakHour=" + peakHour + ", forbidden403Count=" + forbidden403Count + ", forbidden403Rate="
				+ forbidden403Rate + ", books500Count=" + books500Count + ", books500Rate=" + books500Rate + "]";
	}
